...
class Mobile_app extends CI_Controller
{
	...
	public function SendDataSlipToNotify()
	{
        ...
        $hash = shell_exec("curl -X POST -H 'Authorization: Bearer TXeMDn7GHBb19THq8l2YoMRLmCplqJaxc94s8UaX1HH' -F 'message=[ ".$UserMessage." ".$_POST["CustomerID"]." ]' -F 'imageFile=@/home/admin/web/pack1.sakorncable.com/public_html/upload/temp/".$_POST["CustomerID"].".jpg' https://notify-api.line.me/api/notify ");
