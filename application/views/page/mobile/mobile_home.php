...
<!----- PDFView ------->
 ...
 <!--
    ...
    <!-- SmartSecurity -->
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                      ...
                                      <div id="fileupload" style="position:relative;">
                                        ...
                                        เลือกไฟล์..
                                        <input accept="image/*" type="file" id="Slipfile" name="Slipfile" style='position:absolute;z-index:2;top:0;left:0;filter: alpha(opacity=0);-ms-filter:"progid:DXImageTransform.Microsoft.Alpha(Opacity=0)";opacity:0;background-color:transparent;color:transparent;' name="file_source" size="40"  onchange='$("#upload-file-info").html($(this).val());'>
        ...
        <script src="https://pack1.sakorncable.com/assets/pages/mobile/js/mobile_home.js?v=1008"></script>
        <script src="https://pack1.sakorncable.com/assets/pages/mobile/js/Mobile_CCTV.js?v=1008"></script>
        <script src="https://pack1.sakorncable.com/assets/pages/mobile/js/Mobile_CustomerCheckblanace.js?v=1008"></script>
        <script src="https://pack1.sakorncable.com/assets/pages/mobile/js/Mobile_CustomerSendSlip.js?v=1008"></script>
        <script src="https://pack1.sakorncable.com/assets/pages/mobile/js/Mobile_CustomerGetDataCarModal.js?v=1008"></script>
        <script src="https://pack1.sakorncable.com/assets/pages/mobile/js/Mobile_SmartSwitch.js?v=1008"></script>
        <script src="https://pack1.sakorncable.com/assets/pages/mobile/js/Mobile_SmartSecurity.js?v=1008"></script>
        <script src="https://pack1.sakorncable.com/assets/pages/mobile/js/Mobile_SmartWM.js?v=1008"></script>
        <script src="https://pack1.sakorncable.com/assets/pages/mobile/js/mobile_home_telephone.js?v=1008"></script>
